...
// its own. With the retired smuggling, csrf and data-validation bundles still
// present, 11 of the 12 requests below were blocked even after the other
// bundles were fixed; without them all 12 pass.
